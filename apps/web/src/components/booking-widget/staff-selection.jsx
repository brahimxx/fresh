...
export function StaffSelection({ salonId, selectedServices, selected, onSelect }) {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        <div
          onClick={function() { selectStaff(null); }}
          className={
        ...
        {staff.map(function(member) {
          ...
          return (
            <div
              key={member.id}
              onClick={function() { selectStaff(member); }}
              className={
                'p-4 rounded-lg border cursor-pointer transition-all ' +
                (isSelected
                  ? 'border-primary bg-primary/5 ring-2 ring-primary/20'
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    {member.specialties && member.specialties.length > 0 && (
                      <div className="flex gap-1">
                        {member.specialties.slice(0, 2).map(function(specialty, idx) {
                          return (
