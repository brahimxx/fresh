...
export function BookingFormDialog({ open, onOpenChange, initialDate }) {
  ...
  var { data: clients, isLoading: clientsLoading } = useClientSearch(clientSearch);
  ...
  async function onSubmit(data) {
    try {
      ...
      var service = services.find(function(s) { return s.id === data.serviceId; });
          ...
          <div className="space-y-2">
            ...
            {selectedClient ? (
              <div className="flex items-center justify-between p-3 border rounded-lg">
                ...
                <Button type="button" variant="ghost" size="sm" onClick={handleClearClient}>
                  Change
                </Button>
              </div>
            ) : showNewClient ? (
              <div className="space-y-2">
                ...
                <Button type="button" variant="ghost" size="sm" onClick={function() { setShowNewClient(false); }}>
                            ...
                            <CommandGroup>
                              {clients.map(function(client) {
                                return (
                                  <CommandItem
                                    key={client.id}
                                    onSelect={function() { handleClientSelect(client); }}
                                  >
          ...
          <div className="space-y-2">
            ...
            {servicesLoading ? (
              ...
              <Select
                ...
                onValueChange={function(val) { form.setValue('serviceId', val); }}
              >
                <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            {staffLoading ? (
              ...
              <Select
                ...
                onValueChange={function(val) { form.setValue('staffId', val); }}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Select staff member" />
                </SelectTrigger>
                <SelectContent>
                  {Array.isArray(staff) && staff.map(function(member) {
                    return (
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0">
                  <Calendar
                    ...
                    onSelect={function(date) { form.setValue('date', date); }}
                    initialFocus
                  />
                </PopoverContent>
              </Popover>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={function(val) { form.setValue('time', val); }}
              >
                <SelectTrigger>
