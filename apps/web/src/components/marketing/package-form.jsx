...
import { useCreatePackage, useUpdatePackage, formatCurrency } from '@/hooks/use-packages';
...
export function PackageForm({ open, onOpenChange, salonId, pkg, onSuccess }) {
  ...
  var calculatedOriginalPrice = (services || [])
    .filter(function(s) { return selectedServices.includes(s.id); })
  ...
  var savingsPercentage = calculatedOriginalPrice > 0 
                  ...
                  render={function({ field }) {
                    return (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder="e.g., Complete Hair Treatment" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    );
                  ...
                  render={function({ field }) {
                    return (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea {...field} placeholder="Describe what's included..." rows={2} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    );
                ...
                <div className="space-y-2">
                  ...
                  {selectedServices.length > 0 && (
                    <p className="text-sm text-muted-foreground">
                      {selectedServices.length} services selected • Original value: {formatCurrency(calculatedOriginalPrice)}
                    </p>
                  )}
                </div>
