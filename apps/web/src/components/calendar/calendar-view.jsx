...
import { useCalendarBookings, useRescheduleBooking } from '@/hooks/use-bookings';
  ...
  var events = useMemo(function() {
    ...
    return bookings
      ...
      .map(function(booking) {
        var staffColor = staffColorMap[booking.staff_id] || { name: 'blue', hex: '#3b82f6' };
        return {
          id: booking.id,
