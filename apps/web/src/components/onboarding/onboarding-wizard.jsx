...
var ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    description:
      "First, let's create your salon. You'll add your salon details including name, address, and business hours.",
    icon: Store,
  ...
  },
  {
    ...
    description:
      "Add more information about your salon like business hours and policies.",
    icon: Store,
  ...
  },
  {
    ...
    description:
      "Create the services you offer with pricing and duration. You can organize them into categories.",
    icon: Scissors,
  ...
  },
  {
    ...
    description:
      "Invite your staff members and set their working hours. Each team member can manage their own schedule.",
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Your salon is ready to accept bookings. You can start managing appointments right away.",
    icon: CheckCircle2,
...
export function OnboardingWizard() {
  ...
  var { isCompleted, currentStep, completeOnboarding, saveStep } =
    useOnboarding();
